"""tdmcalib.postprocess.render_validation() -- the automatic quarto render
after a successful run, replacing the old preprocess toggle. Mocks
shutil.which/subprocess.run rather than requiring a real Quarto install."""
import subprocess

...
successful `tdmcalib` run under `runs/`, and an in-page OJS "Calibration Run" selector
picks which run's modeled results to view against observed data. `compare.qmd` shows
headline metrics across runs side by side.

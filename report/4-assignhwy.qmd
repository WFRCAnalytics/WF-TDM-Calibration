...
:::: {.columns}
::: {.column width="33%" style="padding-right: 24px;"}
...
// rotated in a narrow strip, freeing up horizontal space in this 33%-wide
...
<div style="display:grid; grid-template-columns:repeat(1, 1fr); gap:0 24px;">

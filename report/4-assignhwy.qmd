...
// near zero. Vehicle Type isn't a Plot facet (whose row label sits off to
// the right by default) -- each vehicle type gets its own chart with its
// name as a `title`, which Plot renders directly above that chart, acting
// as a facet-row label, with the gap below controlling row spacing.
...
html`<div>
  ${["All Roadways", "Freeway", "Non-Freeway"].map(cls => html`<div style="margin-bottom: 40px;">

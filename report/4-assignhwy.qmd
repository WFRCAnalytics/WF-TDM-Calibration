...
@fig-assign-vmt-dumbbell always shows every county, faceted by Vehicle Type (Total, Medium CV, Heavy CV) across the columns and Roadway Class (All Roadways, Freeway, Non-Freeway) down the rows -- only its diff labels follow the Display control below. @fig-assign-compare-interactive, below the chart, shows the same model-vs-target differences at the individual segment level and responds to all three controls: Vehicle Type, Display, and Focus Roadway Class. The values for Box Elder and Weber counties are only the portions within the MPO planning area.
...
Plot.plot({
  ...
  marginLeft: 140,
  marginRight: 60,
  facet: {data: dumbbellData, x: "VehLabel", y: "ClassLabel"},
  fx: {domain: ["Total", "Medium CV", "Heavy CV"]},

...
dumbbellData = vmtT
  .filter(d => d.ClassLevel === 'FTGROUP' && d.vehType === bVehType && d.calib_run === globalCalibRun && (bFocusClass === 'All' || d.FTCLASS === bFocusClass))
  .map(d => ({
    ...d,
